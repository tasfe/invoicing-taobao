...
<body class="login">
	...
	<div class="content">
		...
		<form class="form-vertical login-form" action="index.html">
			...
			<div class="alert alert-error hide">
				...
				<span id="messageSpan"> 输入用户名和密码。</span>
			</div>
			...
			<div class="forget-password">
				<h4>忘记密码 ?</h4>
				<p>
					别担心, 点击 <a href="javascript:;" class=""
						id="forget-password">这里</a> 找回密码.
				</p>
			</div>
		...
		<form class="form-vertical register-form" action="index.html">
			...
			<div class="control-group">
				<label class="control-label visible-ie8 visible-ie9">再次输入
					Your Password</label>
				<div class="controls">
					<div class="input-icon left">
	...
	<!--[if lt IE 9]>	<script src="media/js/excanvas.min.js"></script>	<script src="media/js/respond.min.js"></script>  	<![endif]-->
	...
	jQuery(document).ready(function() {     	
		...
		var messageVar = $(errorMessage);
		if(messageVar == "" || messageVar == null){
			 $('#messageSpan').html("账号或者密码错误");
			 $('.alert-error').show();
		}
